...
const Header = () => {
  ...
  const totalItemInCart = useCartStore((state) => state.total)
      ...
      <nav className="px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between mx-auto mt-12">
          ...
          <div className="flex items-center">
            ...
            <Link to="/auth/login" className="font-medium px-4 lg:px-5 py-2 lg:py-2.5 mr-2">
              {isLoggedIn ? `Welcome back ${userName}` : 'Login'}
            </Link>
          </div>
          <div className="flex gap-2 items-center justify-between">
            ...
            <Link to={'/cart/acc1'}>
              <div className="relative ">
                ...
                <div className="absolute w-[25px] h-[25px] rounded-full bg-red-500 inline-flex items-center justify-center -top-4 left-2">{totalItemInCart}</div>
              </div>
            </Link>
            <Link to={'/profile'}>
