      ...
      <div className="max-w-screen-2xl mx-auto p-5 grid sm:grid-cols-[1fr_4fr] md:grid-cols-[1fr_2fr] lg:grid-cols-[4fr_13fr_13fr] gap-x-[100px] min-h-[70vh]">
        ...
        <div className="flex flex-col col-span-2 lg:col-span-1">
          ...
          <div className="flex py-6">
            ...
            <div className="flex items-center space-x-1 text-green-400">{product.Status}</div>
          </div>
          <div className="text-[1.5rem] tracking-[0.045rem] mb-4">$ {product.Price}</div>
          ...
          <div className="flex w-full mt-4 items-center gap-[10px]">
            ...
            <div className="">
              <button className="ml-[15px] w-[200px] h-[55px] rounded-12 border-none bg-yellow-400 flex items-center justify-center cursor-pointer transition duration-500 overflow-hidden shadow-md relative group" onClick={handAddCart}>
