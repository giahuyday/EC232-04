...
const Detail = () => {
    ...
    return (
        <>
            <section className="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800 my-[40px]">
                            ...
                            <div className="lg:pl-20">
                                <div className="mb-8 ">
                                    <div className="border-b border-[black] bio">
                                        <h2 className="max-w-xl  mb-[10px] text-[24px] font-bold dark:text-gray-400 md:text-4xl">
                                            Macbook Pro M130c90
                                        </h2>
                                    ...
                                    <p className="pt-[30px] inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
