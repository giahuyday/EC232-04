...
import RowTablePointsManage from '../../../components/Admin/RowTablePointsManage'
    ...
    return (
        <>
            <div className=" h-[80px] border-solid border-[black] border-b-[2px] flex justify-between">
                <div className="h-[80px]  text-[24px] font-[600] mt-[10px] ml-[20px]">List User</div>
                                ...
                                <table className="w-full text-sm text-left text-gray-500 dtext-gray-400">
                                    ...
                                    <tbody>
                                        {Users.slice((currentPage - 1) * 5, 5 * currentPage).map((item) => {
                                            return <RowTablePointsManage item={item} key={item.AccountID} />
                                        })}
                                    </tbody>
                                </table>
                            </div>
