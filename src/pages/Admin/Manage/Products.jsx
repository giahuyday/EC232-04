...
const tempProduct = [
  {
    ...
    quantity: 10,
    Status: 'Còn hàng',
    image: 'https://dosi-in.com/images/detailed/42/CDL3_1.jpg',
  },
  {
    CateID: 2,
    Name: 'Áo thun nam',
        ...
        <div className="relative overflow-hidden bg-white shadow-md dbg-gray-800 sm:rounded-lg">
          <div className="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
            <div className="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
              <button type="button" className="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dbg-primary-600 dhover:bg-primary-700 focus:outline-none dfocus:ring-primary-800">
