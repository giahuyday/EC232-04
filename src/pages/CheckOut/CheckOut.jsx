    ...
    <>
      ...
      <div className="flex justify-between">
        ...
        {dataCart.length > 0 ? (
          ...
          {paymentMethod === 'bank' && (
            <form class="flex flex-wrap gap- w-full p-5" id="BankCard">
            <label class="relative w-full flex flex-col" htmlFor="creditCardNumber">
              <span class="font-bold mb-3">Card number</span>
              <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300" type="text" name="card_number" placeholder="0000 0000 0000" value={creditCardNumber} onChange={handleCreditCardNumberChange}/>
            ...
            <label class="relative flex-1 flex flex-col">
              ...
              <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 placeholder-gray-300" type="date" name="expire_date" placeholder="MM/YY" />
              <svg xmlns="http://www.w3.org/2000/svg" class="absolute bottom-0 left-0 -mb-0.5 transform translate-x-1/2 -translate-y-1/2 text-black peer-placeholder-shown:text-gray-300 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
